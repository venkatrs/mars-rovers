...
public class TestTurnRightCommand extends BaseTestCase {
	...
	/**
	 * Method to test TurnRightCommand.preExecute() method.
	 * 
	...
	public void testPreExecute() {
		try {
			...
			Rover rover = null;
			try {
				turnRightCommand.preExecute(rover);
			...
			fail("No other exception should have been thrown from TurnRightCommand.preExecute()!");
		}
	}

	/**
	 * Method to test TurnRightCommand.execute() method.
	 * 
	...
	public void testExecute() {
		...
		Direction expectedDirection = directionMgr.turnRight();
